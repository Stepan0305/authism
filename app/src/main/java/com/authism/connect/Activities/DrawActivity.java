...
public class DrawActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        box = findViewById(R.id.boxDraw);
        home = findViewById(R.id.btnHomeDraw);
        settings = findViewById(R.id.btnBackDraw);
    ...
    public void onDrawClick(View v){
        if (v.getId() == R.id.btnHomeDraw){
            Intent i = new Intent(this, MainActivity.class);
            startActivity(i);
            finish();
        }else if (v.getId() == R.id.btnBackDraw){
            finish();
        }
    }
    private void generateCards() {
        //добавление карточек в box
        ArrayList<Category> categories = new ArrayList<>(ArraysKeeper.drawCards); //встроенные карточки
        DbHelper dbHelper = new DbHelper(this);
        categories.addAll(dbHelper.getAllChildCategories("Рисовать")); //кастомные карточки
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (category.getSoundPath() == null) {
                        mediaPlayer = MediaPlayer.create(DrawActivity.this, category.getSound());
                    } else {
                        mediaPlayer = MediaPlayer.create(DrawActivity.this, Uri.parse(category.getSoundPath()));
                    }
                    mediaPlayer.start();
        ...
        card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(DrawActivity.this, AddNewCardActivity.class);
                i.putExtra("parent", "Рисовать");
                startActivity(i);
            }
        });
        ImageView img = new ImageView(this);
