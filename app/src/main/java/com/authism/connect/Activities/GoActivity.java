...
public class GoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        box = findViewById(R.id.boxGo);
        home = findViewById(R.id.btnHomeGo);
        settings = findViewById(R.id.btnBackGo);
    ...
    public void onGoClick(View v){
        if (v.getId() == R.id.btnHomeGo){
            Intent i = new Intent(this, MainActivity.class);
            startActivity(i);
            finish();
        }else if (v.getId() == R.id.btnBackGo){
            finish();
        }
    }
    ...
    private void generateCards() {
        ...
        ArrayList<Category> categories = new ArrayList<>(ArraysKeeper.goCards); //встроенные карточки
        DbHelper dbHelper = new DbHelper(this);
        categories.addAll(dbHelper.getAllChildCategories("Пойти")); //кастомные карточки
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (category.getSoundPath() == null) {
                        mediaPlayer = MediaPlayer.create(GoActivity.this, category.getSound());
                    } else {
                        mediaPlayer = MediaPlayer.create(GoActivity.this, Uri.parse(category.getSoundPath()));
                    }
                    mediaPlayer.start();
        ...
        card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(GoActivity.this, AddNewCardActivity.class);
                i.putExtra("parent", "Пойти");
                startActivity(i);
            }
        });
        ImageView img = new ImageView(this);
