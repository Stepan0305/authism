...
public class DrinkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        box = findViewById(R.id.boxDrink);
        home = findViewById(R.id.btnHomeDrink);
        settings = findViewById(R.id.btnBackDrink);
    ...
    public void onDrinkClick(View v) {
        if (v.getId() == R.id.btnHomeDrink) {
            Intent i = new Intent(this, MainActivity.class);
            startActivity(i);
            finish();
        } else if (v.getId() == R.id.btnHomeDrink) {
            finish();
        }
    }
    ...
    private void generateCards() {
        ...
        ArrayList<Category> categories = ArraysKeeper.drinkCards; //встроенные карточки
        DbHelper dbHelper = new DbHelper(this);
        categories.addAll(dbHelper.getAllChildCategories("Пить")); //кастомные карточки
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (category.getSoundPath() == null) {
                        mediaPlayer = MediaPlayer.create(DrinkActivity.this, category.getSound());
                    } else {
                        mediaPlayer = MediaPlayer.create(DrinkActivity.this, Uri.parse(category.getSoundPath()));
                    }
                    mediaPlayer.start();
        ...
        card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(DrinkActivity.this, AddNewCardActivity.class);
                i.putExtra("parent", "Пить");
                startActivity(i);
            }
        });
        ImageView img = new ImageView(this);
