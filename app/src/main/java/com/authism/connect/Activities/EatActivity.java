...
public class EatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        box = findViewById(R.id.boxEat);
        home = findViewById(R.id.btnHomeEat);
        settings = findViewById(R.id.btnBackEat);
    ...
    public void onEatClick(View v){
        if (v.getId() == R.id.btnHomeEat){
            Intent i = new Intent(this, MainActivity.class);
            startActivity(i);
            finish();
        }else if (v.getId() == R.id.btnBackEat){
            finish();
        }
    }
    private void generateCards() {
        //добавление карточек в box
        ArrayList<Category> categories = new ArrayList<>(ArraysKeeper.eatCards);//встроенные карточки
        DbHelper dbHelper = new DbHelper(this);
        categories.addAll(dbHelper.getAllChildCategories("Есть")); //кастомные карточки
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (category.getSoundPath() == null) {
                        mediaPlayer = MediaPlayer.create(EatActivity.this, category.getSound());
                    } else {
                        mediaPlayer = MediaPlayer.create(EatActivity.this, Uri.parse(category.getSoundPath()));
                    }
                    mediaPlayer.start();
        ...
        card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(EatActivity.this, AddNewCardActivity.class);
                i.putExtra("parent", "Есть");
                startActivity(i);
            }
        });
        ImageView img = new ImageView(this);
