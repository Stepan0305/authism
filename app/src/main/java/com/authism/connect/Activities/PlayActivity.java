...
public class PlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        box = findViewById(R.id.boxPlay);
        home = findViewById(R.id.btnHomePlay);
        settings = findViewById(R.id.btnBackPlay);
    ...
    public void onPlayClick(View v){
        if (v.getId() == R.id.btnHomePlay){
            Intent i = new Intent(this, MainActivity.class);
            startActivity(i);
            finish();
        }else if (v.getId() == R.id.btnBackPlay){
            finish();
        }
    }
    private void generateCards() {
        //добавление карточек в box
        ArrayList<Category> categories = new ArrayList<>(ArraysKeeper.playCards); //встроенные карточки
        DbHelper dbHelper = new DbHelper(this);
        categories.addAll(dbHelper.getAllChildCategories("Играть")); //кастомные карточки
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (category.getSoundPath() == null) {
                        mediaPlayer = MediaPlayer.create(PlayActivity.this, category.getSound());
                    } else {
                        mediaPlayer = MediaPlayer.create(PlayActivity.this, Uri.parse(category.getSoundPath()));
                    }
                    mediaPlayer.start();
        ...
        card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PlayActivity.this, AddNewCardActivity.class);
                i.putExtra("parent", "Играть");
                startActivity(i);
            }
        });
        ImageView img = new ImageView(this);
