...
public class HygieneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        box = findViewById(R.id.boxHygiene);
        home = findViewById(R.id.btnHomeHygiene);
        settings = findViewById(R.id.btnBackHygiene);
    ...
    public void onHygieneClick(View v){
        if (v.getId() == R.id.btnHomeHygiene){
            Intent i = new Intent(this, MainActivity.class);
            startActivity(i);
            finish();
        }else if (v.getId() == R.id.btnBackHygiene){
            finish();
        }
    }
    ...
    private void generateCards() {
        ...
        ArrayList<Category> categories = new ArrayList<>(ArraysKeeper.hygieneCards); //встроенные карточки
        DbHelper dbHelper = new DbHelper(this);
        categories.addAll(dbHelper.getAllChildCategories("Гигиена")); //кастомные карточки
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (category.getSoundPath() == null) {
                        mediaPlayer = MediaPlayer.create(HygieneActivity.this, category.getSound());
                    } else {
                        mediaPlayer = MediaPlayer.create(HygieneActivity.this, Uri.parse(category.getSoundPath()));
                    }
                    mediaPlayer.start();
        ...
        card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(HygieneActivity.this, AddNewCardActivity.class);
                i.putExtra("parent", "Гигиена");
                startActivity(i);
            }
        });
        ImageView img = new ImageView(this);
